...
import { Nav, Navbar, NavDropdown, Image, Badge, Button, Row, Col, Media } from 'react-bootstrap'
                    ...
                    <Navbar.Brand>
                            ...
                            <Nav className="ml-auto">
                                ...
                                <MediaQuery minWidth={450}>
                                    <span style={{color:'white', fontSize:"1em", fontWeight:"bold"}}>1-(603)-369-4123</span>
                                </MediaQuery>
